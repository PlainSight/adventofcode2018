...
var immuneSystem = [
	{ n: 4555, hp: 9688, immune: 'radiation', weak: 'bludgeoning', attackType: 'radiation', attackDamage: 17, initiative: 1 },
	{ n: 2698, hp: 9598, immune: 'slashing', weak: '', attackType: 'slashing', attackDamage: 29, initiative: 16 },
	{ n: 4682, hp: 6161, immune: '', weak: '', attackType: 'radiation', attackDamage: 13, initiative: 19 },
	{ n: 8197, hp: 4985, immune: '', weak: 'cold', attackType: 'cold', attackDamage: 5, initiative: 18 },
	{ n: 582, hp: 3649, immune: '', weak: '', attackType: 'slashing', attackDamage: 46, initiative: 13 },
	{ n: 53, hp: 5147, immune: 'bludgeoning,slashing', weak: '', attackType: 'cold', attackDamage: 828, initiative: 11 },
	{ n: 5231, hp: 8051, immune: '', weak: 'radiation', attackType: 'radiation', attackDamage: 14, initiative: 9 },
	{ n: 704, hp: 4351, immune: 'cold', weak: 'slashing', attackType: 'radiation', attackDamage: 60, initiative: 2 },
	{ n: 326, hp: 9157, immune: '', weak: 'cold,slashing', attackType: 'radiation', attackDamage: 261, initiative: 6 },
	{ n: 6980, hp: 3363, immune: '', weak: 'radiation', attackType: 'slashing', attackDamage: 4, initiative: 4 }
];
...
function damage(defender, damage) {
	...
	console.log(defender.initiative + ' losses: ' + losses);
	defender.n -= losses;
}
	...
	*/
	...
	immuneSystem.sort(function(a, b) {
		...
		if(target && damageCalculation(g, target) > 0) {
			console.log('immune ' + g.initiative + ' targeted ' + target.initiative);
			g.target = target;
	...
	infection.sort(function(a, b) {
		...
		if(target && damageCalculation(g, target) > 0) {
			console.log('infection ' + g.initiative + ' targeted ' + target.initiative);
			g.target = target;
			targeted[target.initiative] = true;
		}
	});
	...
	allGroups.sort(function(a, b) {
		...
		if(g.n > 0) {
			if (g.target) {
				...
				damage(g.target, damageCalculation(g, g.target));
			}
		}
	});
